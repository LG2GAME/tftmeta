...
import { ChampInfo, ItemInfo } from "@components/common/tooltip/Tooltip";
import {
  useChampions,
  useItems,
  useTraits,
} from "@utils/team-builder/tft-data/useTFTData";
import { fetchCompositions } from "@utils/compositions/FetchComposition";
  ...
  const CompositionChampion = ({ champ }) => {
    ...
    return (
      <div className="comps__content-build-unit">
        ...
        {champHover && (
          <ChampInfo champion={currentChampion} triggerRef={champRef} />
        )}
        {hoveredItem && (
